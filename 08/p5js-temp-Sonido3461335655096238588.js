...
//Hago las variables que cambian dependiendo del nivel de la música
  ...
  noStroke();
// Hago un if que cada 9 frames me cree 35 elipses con colores aleatorios en posiciones aleatorias
// El tamaño de estas esferas varia dependiendo del nivel de la musica
  if(frameCount % 9 == 0){
    for(i = 0; i < numero; i++){
      r = random(0,255);
      g = random(0,255);
